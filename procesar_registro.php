    ...
    if ($name_error == '' && $email_error == '' && $pass_error == '' && $repass_error == '') {
        ...
        if ($sentencia_agregar) { //si se agrega a la bd hacer esto 
            ...
            try {
                ...
                $mail->Username   = 'PONER TU EMAIL AQUI';                     //SMTP username
                $mail->Password   = 'PONER TU CONTRASEÑA AQUI';                               //SMTP password
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
                $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

                //Recipients
                $mail->setFrom('PONER TU EMAIL AQUI', 'PONER TU TITULO AQUI');
